...
namespace TrackerUI
{
    public partial class CreateTounamentForm : Form, IPrizeRequester, ITeamRequester
    {
        List<TeamModel> availableTeams = GlobalConfig.Connection.GetTeam_All();
        List<TeamModel> selectedTeams = new List<TeamModel>();
        List<PrizeModel> selectedPrizes = new List<PrizeModel>();

        public CreateTounamentForm()
        {
            InitializeComponent();
            InitializeLists();
        ...
        private void CreateTounamentForm_Load(object sender, EventArgs e)
        {
        ...
        private void createTournamentButton_Click(object sender, EventArgs e)
        {
            ...
            if (!feeAcceptable || tournamentNameValue.Text.Length == 0)
            {
                MessageBox.Show("This form has invalid information, Please check it and try again, man :)", "Invalid Information", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
